...
const populateDB = async () => {
  ...
  newCandidate = new Candidate({
    name: 'Sharkira',
    email: 'ammara2@illinois.edu',
    graduationDate: 'Spring 2023',
    status: 'Pending',
    major: 'Computer Science',
    gender: 'Female',
    minor: '',
    resumeID: 'https://drive.google.com/open?id=1sXDVR8kYbmz0K-Yhz3tEnrEDyBPnRnel',
    github: 'https://github.com/ahmedammar841',
    linkedIn: 'https://www.linkedin.com/in/ammar-ahmed-221934154/',
    website: '',
  ...
  newCandidate = new Candidate({
    name: 'Gillfunkel',
    email: 'jl28@illinois.edu',
    graduationDate: 'Spring 2021',
    status: 'Pending',
    major: 'CS',
    gender: 'Male',
    minor: '',
    resumeID: 'https://drive.google.com/open?id=1xJL4Je7wkc6yIO1ez4HDR5fovQPx8pV5',
    github: 'https://github.com/Deanplayerljx',
    linkedIn: '',
    website: '',
    role: ['Tech Lead'],
  ...
  newCandidate = new Candidate({
    name: 'Cod Stweart',
    email: 'emileenoh@gmail.com',
    graduationDate: 'Spring 2020',
    status: 'Rejected',
    major: 'CS + Linguistics',
    gender: 'Male',
    minor: '',
    resumeID: 'https://drive.google.com/open?id=1omRq2zBBAiC0R4qRWTIQuXYcbHh9W-7o',
    github: 'https://github.com/emileenoh',
    linkedIn: 'https://www.linkedin.com/in/emilee-noh/',
    website: '',
    role: ['Tech Lead'],
  ...
  newCandidate = new Candidate({
    name: 'James Pong',
    email: 'kshitijkg01@gmail.com',
    graduationDate: 'Fall 2019',
    status: 'Pending',
    major: 'Computer Science',
    gender: 'Female',
    minor: '',
    resumeID: 'https://drive.google.com/open?id=1gPDnbUc6UmsYaMt8nTdrfzMd1JKj1oO1',
    github: 'https://github.com/kshitijkg01',
    linkedIn: 'https://www.linkedin.com/in/kshitij-gupta-04a707138/',
    website: '',
    role: ['Product Manager'],
  ...
  newCandidate = new Candidate({
    name: 'Swim shady',
    email: 'kaviravuri888@gmail.com',
    graduationDate: 'Spring 2023',
    status: 'Pending',
    major: 'Statistics and Computer Science',
    gender: 'Female',
    minor: '',
    resumeID: 'https://drive.google.com/open?id=14XzcS7ey7qkvTuouvtIWag3i9KKo9sbr',
    github: 'https://github.com/k-ravuri',
    linkedIn: 'https://www.linkedin.com/in/kavi-ravuri',
    website: 'https://k-ravuri.github.io/',
  ...
  newCandidate = new Candidate({
    name: 'cousin Finny',
    email: 'nxia3@illinois.edu',
    graduationDate: 'Fall 2019',
    status: 'Pending',
    major: 'Finance',
    gender: 'Female',
    minor: '',
    resumeID: 'https://drive.google.com/open?id=112m3APgba78cHQHHG-puVtArf9T_Rv3n',
    github: '',
    linkedIn: '',
    website: '',
    role: ['UI/UX Designer', 'Tech Lead'],
  ...
  newCandidate = new Candidate({
    ...
    email: 'mc16@illinois.edu',
    graduationDate: 'Fall 2021',
    status: 'Pending',
    major: 'Computer Engineering',
    gender: 'Female',
    minor: '',
    resumeID: 'https://drive.google.com/open?id=1Yu0yPBuVGYfpfrMsx5i9Dt67R08iLgI6',
    github: '',
    linkedIn: '',
    website: '',
    role: ['Product Manager'],
  ...
  newCandidate = new Candidate({
    name: 'tank sinatra',
    email: 'gvs2@illinois.edu',
    graduationDate: 'Spring 2020',
    status: 'Rejected',
    major: 'Computer Science+Astronomy',
    gender: 'Female',
    minor: '',
    resumeID: 'https://drive.google.com/open?id=1rCz_f8653Rw3x--ECrTHhxAgRUbXKUJc',
    github: 'https://github.com/gauravsharma1999',
    linkedIn: 'https://www.linkedin.com/in/gaurav-sharma1999/',
    website: 'https://gauravsharma1999.github.io',
  ...
  newCandidate = new Candidate({
    name: 'Sir caviar',
    email: 'xinyig2@illinois.edu',
    graduationDate: 'Fall 2020',
    status: 'Pending',
    major: 'Computer Engineering',
    gender: 'Female',
    minor: '',
    resumeID: 'https://drive.google.com/open?id=19r3wpOwkWzMee3mfvUOZAwwi_ZDC8dmq',
    github: '',
    linkedIn: '',
    website: '',
    role: ['Tech Lead'],
  ...
  newCandidate = new Candidate({
    name: 'von trapp',
    email: 'MZhao14@gmail.com',
    graduationDate: 'Spring 2020',
    status: 'Rejected',
    major: 'Computer Science',
    gender: 'Female',
    minor: '',
    resumeID: 'https://drive.google.com/open?id=1XjBzoeCqpQitzkRuMUy1N6icAJe-T4Vq',
    github: 'https://github.com/zzhao36',
    linkedIn: 'https://www.linkedin.com/in/zixuan-zhao-b35118a5/',
    website: '',
    role: ['Tech Lead'],
  ...
  newCandidate = new Candidate({
    name: 'gilly joel',
    email: 'pavitra3@illinois.edu',
    graduationDate: 'Spring 2021',
    status: 'Pending',
    major: 'Computer Engineering',
    gender: 'Female',
    minor: '',
    resumeID: 'https://drive.google.com/open?id=111sAKqDTL3sgtqUpsJBYIbwWixur_t6y',
    github: 'https://github.com/Pavitra122',
    linkedIn: 'https://www.linkedin.com/in/pavitrashadvani/',
    website: 'https://pavitra122.github.io/',
  ...
  newCandidate = new Candidate({
    ...
    email: 'psp2@illinois.edu',
    graduationDate: 'Fall 2021',
    status: 'Rejected',
    major: 'Statistics & Computer Science',
    gender: 'Female',
    minor: '',
    resumeID: 'https://drive.google.com/open?id=1f2d-crZAHd6pPmyHIKi4y3M0n3nsM6K2',
    github: '',
  ...
  newCandidate = new Candidate({
    ...
    email: 'alanren2@illinois.edu',
    graduationDate: 'Spring 2021',
    status: 'Rejected',
    major: 'Computer Engineering',
    gender: 'Male',
    minor: '',
    resumeID: 'https://drive.google.com/open?id=1rxZGxlj9JygRoTI0_Kd7CwSTqARlLutI',
    github: 'https://github.com/alanren2',
  ...
  newCandidate = new Candidate({
    name: 'Harley finn',
    email: 'bulzii2@illinois.edu',
    graduationDate: 'Fall 2022',
    status: 'Pending',
    major: 'Computer Science and Statistics',
    gender: 'Male',
    minor: '',
    resumeID: 'https://drive.google.com/open?id=1YTxKgTiVyVOHNPMveTYDOH1tzee1zHDW',
    github: 'https://github.com/byamba3',
    linkedIn: '',
    website: 'https://byamba3.github.io/Portfolio/',
    role: ['Product Manager'],
    githubContributions: '60',
    year: 'Sophomore',
    classesTaken: '',
  ...
  newCandidate = new Candidate({
    name: 'Bubble fett',
    email: 'anoojl2@illinois.edu',
    graduationDate: 'Fall 2019',
    status: 'Rejected',
    major: 'Computer Science & Linguistics',
    gender: 'Male',
    minor: '',
    resumeID: 'https://drive.google.com/open?id=1L6ieGV9q0JM8MwSW2TMeyMf431s24JoJ',
    github: 'https://github.com/anoojlal',
    linkedIn: 'https://www.linkedin.com/in/anoojlal/',
    website: 'https://anoojlal.github.io/',
    role: ['Product Manager'],
  ...
  newCandidate = new Candidate({
    ...
    gender: 'Female',
    minor: '',
    resumeID: 'https://drive.google.com/open?id=1UINEIvEC91CTNezEreQ7JPJthyr9Lpt1',
    github: 'https://github.com/ashankv',
    linkedIn: 'https://www.linkedin.com/in/ashank-verma-93a57b121/',
    website: 'https://ashankv.github.io/personal_website/',
    role: ['Tech Lead'],
    githubContributions: '33',
    year: 'Junior',
    classesTaken: '',
  ...
  newCandidate = new Candidate({
    ...
    email: 'cs2@illinois.edu',
    graduationDate: 'Fall 2019',
    status: 'Rejected',
    major: 'Computer Science ',
    gender: 'Male',
    minor: '',
    resumeID: 'https://drive.google.com/open?id=1Q3duN0lNQcxQgRWcSvSP5uv5Sc2Zyora',
    github: '',
    linkedIn: '',
    website: '',
    role: ['Software Developer'],
  ...
  newCandidate = new Candidate({
    name: 'Filly nelson',
    email: 'fz5@illinois.edu',
    graduationDate: 'Spring 2023',
    status: 'Rejected',
    major: 'undecided (considering IT)',
    gender: 'Female',
    minor: '',
    resumeID: 'https://drive.google.com/open?id=1Rb66WPYUKpzZUQe3Tc0x95OHaYWHSV6t',
    github: '',
    linkedIn: '',
    website: '',
    role: ['Software Developer'],
  ...
  newCandidate = new Candidate({
    ...
    email: 'mmallya2@illinois.edu',
    graduationDate: 'Fall 2021',
    status: 'Accepted',
    major: 'Computer Science',
    gender: 'Female',
    minor: '',
    resumeID: 'https://drive.google.com/open?id=1xmQsgo04J3gQSwSA9qmjGxywsYicxbAt',
    github: 'https://github.com/meghatron3000',
    linkedIn: 'https://www.linkedin.com/in/megha-mallya/',
    website: 'http://www.meghamallya.me/',
    role: ['UI/UX Designer', 'Tech Lead'],
  ...
  newCandidate = new Candidate({
    ...
    email: 'malli2@illinois.edu',
    graduationDate: 'Fall 2019',
    status: 'Rejected',
    major: 'Computer Science & Anthropology',
    gender: 'Male',
    minor: '',
    resumeID: 'https://drive.google.com/open?id=1bcXKt2EFd_zJ_MLtP_T73gWJQlXfHcav',
    github: 'https://github.com/pavanim101',
    linkedIn: '',
    website: '',
    role: ['Software Developer'],
  ...
  newCandidate = new Candidate({
    ...
    email: 'asg@illinois.edu',
    graduationDate: 'Fall 2019',
    status: 'Pending',
    major: 'Computer Engineering',
    gender: 'Female',
    minor: '',
    resumeID: 'https://drive.google.com/open?id=188LNUEHAIa4M_GEdLdePXnqmA2uOhQNp',
    github: '',
    linkedIn: 'https://www.linkedin.com/in/jusxu',
    website: '',
    role: ['UI/UX Designer', 'Product Manager'],
    githubContributions: 'N/A',
    year: 'Junior',
  ...
  newCandidate = new Candidate({
    ...
    email: 'mfelix2@illinois.edu',
    graduationDate: 'Spring 2021',
    status: 'Pending',
    major: 'computer science',
    gender: 'Male',
    minor: '',
    resumeID: 'https://drive.google.com/open?id=140ELIoBu7MBbNuFXBJ_MKAjaB_wWSmpk',
    github: '',
    linkedIn: 'https://goo.gl/34JNGx',
    website: '',
    role: ['UI/UX Designer', 'Product Manager'],
    githubContributions: 'N/A',
    year: 'Freshman',
  ...
  newCandidate = new Candidate({
    ...
    email: 'nmanda2@illinois.edu',
    graduationDate: 'Spring 2022',
    status: 'Pending',
    major: 'Computer Science & Linguistics',
    gender: 'Female',
    minor: '',
    resumeID: 'https://drive.google.com/open?id=1ngorA81wh3LabhHp3gS1Vt-Lnub33s7D',
    github: '',
    linkedIn: 'https://www.linkedin.com/in/niharika-manda-b2319a144/',
    website: '',
    role: ['Product Manager'],
    githubContributions: 'N/A',
    year: 'Senior',
  ...
  newCandidate = new Candidate({
    name: 'berzerker',
    email: 'tambati2@illilnois.edu',
    graduationDate: 'Spring 2023',
    status: 'Pending',
    major: 'Computer Science',
    gender: 'Female',
    minor: '',
    resumeID: 'https://drive.google.com/open?id=134ktqZCG7FbXpxB6UOp5KWuDwEVZGbYZ',
    github: 'https://github.com/teja635',
    linkedIn: 'https://www.linkedin.com/in/teja-ambati/',
    website: '',
    role: ['Product Manager'],
    githubContributions: '7',
    year: 'Sophomore',
  ...
  newCandidate = new Candidate({
    name: 'Jennifer Wu',
    email: 'jw7@illinois.edu',
    graduationDate: 'Spring 2022',
    status: 'Pending',
    major: 'Computer Science',
    gender: 'Female',
    minor: '',
    resumeID: 'https://drive.google.com/open?id=1yIB4IDra4vLaSH1rWow5W9qGC2R44Z1N',
    github: 'https://github.com/wujenwu',
    linkedIn: 'https://www.linkedin.com/in/jenwu20/',
    website: 'https://wujenwu.github.io/hello/',
    role: ['UI/UX Designer', 'Software Developer'],
  ...
  newCandidate = new Candidate({
    name: 'Tundra',
    email: 'awang47@illinois.edu',
    graduationDate: 'Spring 2023',
    status: 'Done Interviewing',
    major: 'Computer Engineering',
    gender: 'Female',
    minor: '',
    resumeID: 'https://drive.google.com/open?id=1iA9heKaHaLaRTvuX9kEVDVzVLoOM7rFy',
    github: '',
...
//   newCandidate = new Candidate({
//     name: 'May B.Dunn',
//     email: 'rchiu7@illinois.edu',
//     graduationDate: 'Spring 2020',
//     status: 'Pending',
//     major: 'Computer Science',
//     gender: 'Female',
//     minor: '',
//     resumeID: 'https://drive.google.com/open?id=1ESNSgb8XXc27TqSjajvjyOpwmm9xVAiF',
//     github: 'https://github.com/rgychiu',
//     linkedIn: '',
//     website: 'https://rgychiu.github.io/mysite/',
//     role: ['Tech Lead'],
...
//     techExperience:
//       'Github: https://github.com/rgychiu First Internship Website - https://myluvtalk.com/ (Designed and created every page with some additional features added by developer team afterwards) Further web development with Topcoin internship Personal Website - https://rgychiu.github.io/mysite/ Sabermetrics Lunar Phases and Crime Data Science JavaFX Transport GUI(CS 125 Final Project) Introduction to Computer Science(CS 125)',
//     howTheyKnowUs: 'Friend/Word of mouth',
//     additionalComments: ''
//   })
//   await newCandidate.save()
...
//   newCandidate = new Candidate({
//     name: 'Doris Shutt',
//     email: 'tkotha2@illinois.edu',
//     graduationDate: 'Spring 2021',
//     status: 'Rejected',
//     major: 'Computer Engineering',
//     gender: 'Male',
//     minor: '',
//     resumeID: 'https://drive.google.com/open?id=18kIsQVU_HReQdqrYAFG93H7WR1KcAcPX',
//     github: '',
//     linkedIn: '',
//     website: '',
//     role: ['UI/UX Designer,Tech Lead',
...
//   newCandidate = new Candidate({
//     name: '	Ivana Tinkle',
//     email: 'rbagga2@illinois.edu',
//     graduationDate: 'Spring 2020',
//     status: 'Rejected',
//     major: 'Computer Science',
//     gender: 'Male',
//     minor: '',
//     resumeID: 'https://drive.google.com/open?id=16ryQC48PpZuQmkfhs6NXDR37EKhkIv-x',
//     github: 'https://www.github.com/rbagga',
//     linkedIn: 'https://www.linkedin.com/in/rishu-b-a88116119',
//     website: 'https://www.rishumusic.com',
//     role: ['UI/UX Designer,Software Developer'],
...
//   newCandidate = new Candidate({
//     name: 'Marius Quick',
//     email: 'vsrvtsn2@illinois.edu',
//     graduationDate: 'Spring 2020',
//     status: 'Pending',
//     major: 'Computer Engineering',
//     gender: 'Male',
//     minor: '',
//     resumeID: 'https://drive.google.com/open?id=1xMCbLrw5DB-S-UrD52MEr6YIjrgAxUaf',
//     github: 'https://github.com/vsrivatsan53',
//     linkedIn: '',
//     website: '',
//     role: ['UI/UX Designer,Tech Lead',
...
//   newCandidate = new Candidate({
//     name: 'Suryaa Murali',
//     email: 'msuryaa07@gmail.com',
//     graduationDate: 'Spring 2020',
//     status: 'Accepted',
//     major: 'Undeclared (working towards coursework in Cognitive/Information Science)',
//     gender: 'Male',
//     minor: '',
//     resumeID: 'https://drive.google.com/open?id=1PMTUzBtVZY3gVOhxl4mXsXX99AAgZOIG',
//     github: 'https://github.com/msuryaa07',
//     linkedIn: 'https://www.linkedin.com/in/msuryaa07/',
//     website: 'https://suryaamurali.voog.com/',
//     role: ['Product Manager',
...
//   newCandidate = new Candidate({
//     name: 'Gilda Lily',
//     email: 'hzdeng2@illinois.edu',
//     graduationDate: 'Spring 2023',
//     status: 'Pending',
//     major: 'Computer Engineering',
//     gender: 'Male',
//     minor: '',
//     resumeID: 'https://drive.google.com/open?id=1kmiNbbM_fxISdfzA1iOrf4p3BjP_fxMP',
//     github: 'https://github.com/hubertdeng123',
//     linkedIn: 'https://www.linkedin.com/in/hubert-deng-b3354311b/',
//     website: 'http://hubertdeng.com',
//     role: ['Tech Lead',
...
//       techExperience:
//       'Personal Website: https://github.com/hubertdeng123/hubertdeng123.github.io Software Internship at Meiya Pico Machine Learning Research at DTU Website information retriever: https://github.com/hubertdeng123/websiteinformationretriever',
...
//   newCandidate = new Candidate({
//     name: 'Mand Lynne',
//     email: 'hrimaw2@illinois.edu',
//     graduationDate: 'Spring 2022',
//     status: 'Accepted',
//     major: 'Computer Science',
//     gender: 'Female',
//     minor: '',
//     resumeID: 'https://drive.google.com/open?id=1klXwUFeBysvMQOaln8N4SLG1Hf1ukTWH',
//     github: 'https://github.com/hrimaw2',
...
//   newCandidate = new Candidate({
//     name: 'Felix Li',
//     email: 'felixli2@illinois.edu',
//     graduationDate: 'Fall 2022',
//     status: 'Rejected',
//     major: 'Computer Engineering',
//     gender: 'Male',
//     minor: '',
//     resumeID: 'https://drive.google.com/open?id=1hWQfr7Xfm8YMoR6yAUTVGbK6oXCc1Oah',
//     github: '',
//     linkedIn: '',
//     website: '',
//     role: ['Tech Lead'],
...
//     email: 'dayan2@illinois.edu',
//     graduationDate: 'Fall 2019',
//     status: 'Rejected',
//     major: 'Computer Science and Mathematics',
//     gender: 'Male',
//     minor: '',
//     resumeID: 'https://drive.google.com/open?id=1CjnCBx8a4piiHDzEdIw4uxbpyp9_5op2',
//     github: 'https://github.com/idayan03',
//     linkedIn: 'https://www.linkedin.com/in/ismail-emre-d-34b733a5/',
//     website: 'https://idayan03.github.io/',
//     role: ['Product Manager'],
...
//     gender: 'Male',
//     minor: '',
//     resumeID: 'https://drive.google.com/open?id=1JKkP5BkJ_wfyfeUNiizurtfDKkLMn5Bn',
//     github: '',
//     linkedIn: 'https://www.linkedin.com/in/srinija-kakumanu-1b9131127/',
//     website: '',
//     role: ['UI/UX Designer'],
//       githubContributions: 'N/A',
//       year: 'Junior',
...
//   newCandidate = new Candidate({
//     name: 'Phil Landers',
//     email: 'nrajkum2@illinois.edu',
//     graduationDate: 'Fall 2021',
//     status: 'Pending',
//     major: 'Mechanical Engineering',
//     gender: 'Female',
//     minor: '',
//     resumeID: 'https://drive.google.com/open?id=1FnAe2szb1933wqfyYaY852sTvUZfqvQl',
//     github: '',
//     linkedIn: '',
//     website: '',
//     role: ['Tech Lead'],
...
//   newCandidate = new Candidate({
//     name: 'Robyn Banks',
//     email: 'tigerz2@illinois.edu',
//     graduationDate: 'Spring 2023',
//     status: 'Pending',
//     major: 'Statistics and Computer Science ',
//     gender: 'Female',
//     minor: '',
//     resumeID: 'https://drive.google.com/open?id=1l2REtJqU3F3GHWS_OkE-E02_QFNABKqD',
//     github: 'https://github.com/heyTalq',
//     linkedIn: 'https://www.linkedin.com/in/tigerzha/',
//     website: '',
//     role: ['UI/UX Designer'],
...
//     gender: 'Female',
//     minor: '',
//     resumeID: 'https://drive.google.com/open?id=1VslWi_olYh6KMjnt3zXVyQJ8LJg6_KG_',
//     github: 'https://github.com/alex-wuu',
//     linkedIn: '',
//     website: '',
//     role: ['Software Developer'],
...
//   newCandidate = new Candidate({
//     name: 'Anita Room	',
//     email: 'dachang3@illinois.edu',
//     graduationDate: 'Spring 2021',
//     status: 'Pending',
//     major: 'Finance',
//     gender: 'Female',
//     minor: '',
//     resumeID: 'https://drive.google.com/open?id=1V3ZVDWKaFSOxvY9QfGTMN-JQQP-mVJJg',
//     github: 'https://github.com/davidachang',
...
//   newCandidate = new Candidate({
//     name: 'abcd',
//     email: 'jingtao2@illinois.edu',
//     graduationDate: 'Spring 2023',
//     status: 'Pending',
//     major: 'Computer Engineering',
//     gender: 'Male',
//     minor: '',
//     resumeID: 'https://drive.google.com/open?id=1_dhvdXQ05xz09QIyPIAtMhtnwHI7txEy',
//     github: 'https://github.com/icarusoars',
//     linkedIn: '',
//     website: 'https://icarusoars.github.io',
//     role: ['Product Manager'],
...
//   newCandidate = new Candidate({
//     name: 'Ima Hogg',
//     email: 'aliang6@illinois.edu',
//     graduationDate: 'Fall 2020',
//     status: 'Accepted',
//     major: 'Engineering Physics',
//     gender: 'Male',
//     minor: '',
//     resumeID: 'https://drive.google.com/open?id=1Rmf25VKHjqbY4TLPda_KuHd8gMVTrqiC',
//     github: 'https://github.com/itsabigaundy',
...
//   newCandidate = new Candidate({
//     name: 'Joe King',
//     email: 'jlin79@illinois.edu',
//     graduationDate: 'Spring 2020',
//     status: 'Pending',
//     major: 'Computer Science',
//     gender: 'Male',
//     minor: '',
//     resumeID: 'https://drive.google.com/open?id=1EXk5_44ERF81n00_nH1KM-oZL2Szybhf',
//     github: '',
//     linkedIn: '',
//     website: '',
//     role: ['Product Manager'],
...
//   newCandidate = new Candidate({
//     name: 'Alan Fang',
//     email: 'alansf2@illinois.edu',
//     graduationDate: 'Spring 2022',
//     status: 'Interviewing',
//     major: 'Computer Science',
//     gender: 'Female',
//     minor: '',
//     resumeID: 'https://drive.google.com/open?id=1FvpGNIMwB3THJDqpRFfC4NW3Pmnc7uGz',
//     github: 'https://github.com/alan-fang',
...
//   newCandidate = new Candidate({
//     name: 'Libby Doe',
//     email: 'agarg22@illinois.edu',
//     graduationDate: 'Fall 2021',
//     status: 'Interviewing',
//     major: 'Computer Science',
//     gender: 'Male',
//     minor: '',
//     resumeID: 'https://drive.google.com/open?id=1Zzftg-pFdF1Z_8AcvTLypaxD0k-crUOc',
//     github: 'https://github.com/angadgarg25',
//     linkedIn: 'https://www.linkedin.com/in/angad-garg-655014122/',
//     website: '',
//     role: ['UI/UX Designer','Software Developer'],
...
//   newCandidate = new Candidate({
//     name: 'Washama Butt',
//     email: 'jlp3@illinois.edu',
//     graduationDate: 'Spring 2021',
//     status: 'Invalid',
//     major: 'Computer Science',
//     gender: 'Female',
//     minor: '',
//     resumeID: 'https://drive.google.com/open?id=19J26gjdo-ECbIiuSFJ6OHl_YR-VE3lmB',
//     github: 'https://github.com/jlp-io',
//     linkedIn: '',
//     website: '',
//     role: ['Product Manager'],
...
//   newCandidate = new Candidate({
//     name: 'Laho La',
//     email: 'aamin28@illinois.edu',
//     graduationDate: 'Fall 2022',
//     status: 'Interviewing',
//     major: 'Mathematics and Computer Science',
//     gender: 'Female',
//     minor: '',
//     resumeID: 'https://drive.google.com/open?id=1IpUwR4PMl0nLM6hsGLsqNNfIEPevqYbO',
//     github: 'https://github.com/aarnika/BallerRunnersApp',
//     linkedIn: 'https://www.linkedin.com/in/aarnikamin/',
//     website: '',
//     role: ['Product Manager'],
//     githubContributions: '',
//     year: 'Sophomore',
